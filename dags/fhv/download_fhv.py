...
dag = DAG(
    "download_fhv_data",
    description="Monthly fhv data download",
...
with dag:
    sense_fhv_parquet = PythonOperator(
        task_id="sense_fhv_parquet",
    ...
    download_fhv_parquet = PythonOperator(
        task_id="download_fhv_parquet",
    ...
    sense_fhv_parquet >> download_fhv_parquet
